                        ...
                        {totalVariaveis > 0 ? (
                          <div className={styles.templateVariablesSection}>
                            ...
                            <span className={styles.templateVariablesHelp}>
                                Variáveis fixas: {"{{nome_whatsapp}}"}, {"{{nome_contato}}"}, {"{{email_contato}}"}, {"{{numero_contato}}"}, {"{{campo_contato}}"}, {"{{interesse}}"}, {"{{campanha}}"}, {"{{origem}}"}, {"{{status_lead}}"}, {"{{protocolo_atual}}"} e {"{{ultimo_protocolo}}"}.
                            </span>
                          </div>
                        ) : templateAtual ? (
