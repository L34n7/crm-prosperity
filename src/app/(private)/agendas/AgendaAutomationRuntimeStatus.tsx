...
.agendaAutomationSection.isRuntimeActive .agendaAutomationField input,.agendaAutomationSection.isRuntimeActive .agendaAutomationField select{height:39px!important;font-size:12px!important;padding:0 11px!important}
