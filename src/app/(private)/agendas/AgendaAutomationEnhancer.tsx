...
.agendaAutomationSection:before{content:"";position:absolute;inset:0 0 auto;height:3px;background:linear-gradient(90deg,var(--crm-primary-strong),color-mix(in srgb,var(--crm-primary-strong) 35%,#21a179))}
