...
.agendaNichoSection>.row{justify-content:flex-start!important;gap:8px!important}.agendaNichoSection>.row>button{margin-left:auto!important}.agendaNichoBadge{min-height:23px;padding:0 9px;border:1px solid var(--crm-primary-border);border-radius:999px;background:var(--crm-primary-soft);color:var(--crm-primary-text);display:inline-flex;align-items:center;align-self:center;font-size:10px;font-weight:900;line-height:1;white-space:nowrap}.agendaNichoSection select[data-niche-locked="true"]{border-color:var(--crm-primary-border)!important;background:var(--crm-primary-soft)!important;color:var(--crm-primary-text)!important;font-weight:800;opacity:1!important;cursor:default}
