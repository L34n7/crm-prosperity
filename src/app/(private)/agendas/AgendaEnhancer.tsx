...
.agendaGoogleDrawerTools{display:inline-flex;align-items:center;gap:7px;flex-wrap:wrap}.agendaGoogleEventOpen{min-height:36px!important;height:36px!important;text-decoration:none!important;border-color:color-mix(in srgb,#4285f4 35%,var(--crm-border))!important;background:color-mix(in srgb,#4285f4 7%,var(--crm-surface))!important;color:color-mix(in srgb,#4285f4 75%,var(--crm-text-strong))!important}.agendaGoogleConflict{min-height:25px;padding:0 9px;border:1px solid var(--crm-warning-border);border-radius:999px;background:var(--crm-warning-bg);color:var(--crm-warning-text);display:inline-flex;align-items:center;font-size:9px;font-weight:900}.agendaGoogleConflict.isGoogle{border-color:var(--crm-primary-border);background:var(--crm-primary-soft);color:var(--crm-primary-text)}
