...
function formFromImovel(i:Imovel):FormImovel{return {
    ...
    <main className={styles.page}>
      <section className={styles.toolbar}>
        ...
        <div className={styles.toolbarActions}>
          <button className={styles.secondaryButton} type="button" onClick={()=>router.push("/configuracoes#integracao-imobiliaria")}><Cable size={17}/>Integração API</button>
