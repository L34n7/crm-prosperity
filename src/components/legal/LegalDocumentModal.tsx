...
> = {
  ...
  mensageria: {
    titulo: "Política de Mensageria e Uso Aceitável",
    href: "/politica-de-mensageria",
    descricao:
      "Regras para bases de contatos, opt-in, campanhas, WhatsApp e uso responsável dos canais.",
  },
  exclusao: {
