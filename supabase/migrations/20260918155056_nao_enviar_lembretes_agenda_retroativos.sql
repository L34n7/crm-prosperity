-- Evita envio retroativo de confirmações, lembretes e avisos da agenda.
-- Se o horário calculado pela antecedência já passou no momento do planejamento,
-- a execução não deve ser criada nem empurrada para "agora".
