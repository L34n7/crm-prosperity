-- Corrige a origem dos filtros do catalogo imobiliario.
-- Mantem a view restrita ao service role e torna pesquisaveis os imoveis
-- externos indisponiveis e as metragens recebidas em campos alternativos/texto.
...
select
  ...
  coalesce(
    externo.area_m2,
    externo.area_util_m2,
    externo.area_total_m2,
    externo.area_terreno_m2,
    nullif(
      replace(
        substring(
