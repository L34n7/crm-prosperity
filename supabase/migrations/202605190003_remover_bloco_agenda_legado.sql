-- Remove o bloco legado de agenda da lista de tipos permitidos para novos registros.
-- A constraint fica NOT VALID para nao quebrar caso ainda existam nodes historicos desse tipo.
